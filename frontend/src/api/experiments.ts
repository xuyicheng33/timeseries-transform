 ...
 * 创建实验组
 */
export async function createExperiment(data: ExperimentCreateRequest): Promise<ExperimentDetail> {
 ...
 * 获取实验组汇总统计
 */
export async function getExperimentSummary(experimentId: number): Promise<ExperimentSummary> {
