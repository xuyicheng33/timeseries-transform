...
def validate_form_field(
    value: str, field_name: str, max_length: int = 255, min_length: int = 1, required: bool = True
) -> str:
    """
    校验表单字段
...
def calculate_metrics(true_values: np.ndarray, pred_values: np.ndarray, handle_invalid: bool = False) -> dict:
    """
    计算评估指标
